...
export function buildAssociatesBookHtml(members: MemberDetail[]): string {
...
<head>
  ...
  <style>
    ...
    .entry h2 { font-size: 9.5pt; margin: 0 0 0.25rem; }
    dl {
      display: grid;
    ...
    dt { color: #666; }
    dd { margin: 0; }
    .entries { column-count: 2; column-gap: 1.5rem; }
    @media print {
      body { margin: 0.5rem; }
